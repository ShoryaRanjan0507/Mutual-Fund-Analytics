"""
Mutual Fund Analytics - Exploratory Data Analysis (EDA) Jupyter Notebook Generator

This module programmatically constructs and executes the EDA_Analysis.ipynb Jupyer notebook,
generating 16 visual plots representing historical metrics.
"""
...
def create_and_execute_notebook():
    """
    Builds the cells for EDA_Analysis.ipynb, saves the notebook, and executes
    all cells programmatically using nbconvert to populate internal output logs.
    """
...
"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# 1. Plotly daily NAV for all 40 schemes (2022 - 2026)
...
"""))
    ...
    # Cell 7: Markdown Insight 3
    cells.append(nbf.v4.new_markdown_cell("""> **Insight 3 (NAV Correlation)**: Daily returns correlation analysis shows that Large Cap funds share a high correlation coefficient exceeding 0.90, while Gilt and Debt funds show low or slightly negative correlation to equity, indicating significant diversification. (Refer to **Chart 2: NAV Daily Return Correlation Matrix**).
"""))
...
"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# 6. Monthly SIP Inflow Trend (2022 - 2025)
conn = sqlite3.connect(db_path)
...
"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# 7. Category Inflow Heatmap
conn = sqlite3.connect(db_path)
...
"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# 8. Folio count growth line chart
conn = sqlite3.connect(db_path)
...
"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# 10. Investor Demographics
conn = sqlite3.connect(db_path)
...
"""))
    ...
    cells.append(nbf.v4.new_code_cell("""# 13. State-wise and Tier-wise split
conn = sqlite3.connect(db_path)
...
"""))
    ...
    try:
        ...
        print(f"[ERROR] Failed to execute the notebook: {e}")
        return False
